<?php
// source: C:\xampp\htdocs\exampleCalc\app/config/config.neon 
// source: C:\xampp\htdocs\exampleCalc\app/config/config.local.neon 

class Container_076ef873a4 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\xampp\htdocs\exampleCalc\app',
			'wwwDir' => 'C:\xampp\htdocs\exampleCalc\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\exampleCalc\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\exampleCalc\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\exampleCalc\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\exampleCalc\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory()
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory
		{
			...
			public function __construct(Container_076ef873a4 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\exampleCalc\app/../temp/cache/latte');
